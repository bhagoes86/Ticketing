                            ...
                            <div class="col-md-8 col-md-offset-2">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <?php if ($peserta!=null): ?>
                                        ...
                                        <tr <?php if($row->ID_TIKET==$edit){ echo "class='info'";} ?>>
                                            <td><?php echo $i+1; ?></td>
                                            <?php if ($row->ID_TIKET!=$edit): ?>
                    ...
                    <div class="tab-pane active in" id="login">
                        <div class="row" style="margin-top:20px; padding:20px">
                            <div class="col-md-8 col-md-offset-2" style="text-align:left">
                                ...
                                <?php endif ?>
                                <form class="form-horizontal" action="<?php echo base_url(); ?>dashboard/validasi_regis/<?php echo $edit; ?>" method="post" style="text-align:left">
